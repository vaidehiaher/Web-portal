import { User, Student, Faculty, JobListing, Scholarship, DriveEvent, Analytics } from '@/types'
...
export const mockJobListings: JobListing[] = [
  {
    ...
    type: 'full-time',
    package: { min: 120000, max: 150000, currency: 'USD' },
  ...
  },
  {
    ...
    type: 'internship',
    package: { min: 5000, max: 7000, currency: 'USD' },
